##
# The controller responsible for dealing with logging in to the application
class HomeController < ApplicationController
  ...
  def login
    ...
    if access_token == :unauthorized
      ...
      validation_message = 'The GitHub user provided is not apart of the msoe-sse GitHub organization. 
                            Please contact the SSE Webmaster for assistance.'
      redirect_to '/', alert: validation_message
    else
